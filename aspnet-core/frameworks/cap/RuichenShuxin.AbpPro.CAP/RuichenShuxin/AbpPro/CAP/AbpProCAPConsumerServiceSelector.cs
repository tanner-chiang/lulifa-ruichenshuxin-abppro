...
[ExposeServices(typeof(IConsumerServiceSelector), typeof(AbpProCAPConsumerServiceSelector))]

public class AbpProCAPConsumerServiceSelector : ConsumerServiceSelector
{
    /// <summary>
    /// CAP配置
    /// </summary>
    ...
    protected override IEnumerable<ConsumerExecutorDescriptor> FindConsumersFromInterfaceTypes(IServiceProvider provider)
    {
        ...
        var logger = provider.GetRequiredService<ILogger<AbpProCAPConsumerServiceSelector>>();
