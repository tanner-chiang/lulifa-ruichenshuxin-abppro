...
/// </summary>
public abstract class DataProtectionManagementController : AbpProControllerBase<DataProtectionResource>
{
}
...
/// </summary>
public abstract class DataProtectionManagementController<
    TAppService,
    TEntityDto,
    TKey,
    TGetListInput,
...
{
    protected DataProtectionManagementController(TAppService appService)
        : base(appService)
    {
    }
}
