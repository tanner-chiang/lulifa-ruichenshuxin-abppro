...
public class Vben5NavigationSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public IVben5NavigationManager Vben5NavigationManager { get; }
    protected IMenuRepository MenuRepository { get; }
    protected ILayoutRepository LayoutRepository { get; }
    protected Vben5NavigationOptions Options { get; }

    public Vben5NavigationSeedContributor(
        ...
        IVben5NavigationManager vben5NavigationManager,
        IOptions<Vben5NavigationOptions> options)
    {
        ...
        Vben5NavigationManager = vben5NavigationManager;
    ...
    public virtual async Task SeedAsync(DataSeedContext context)
    {
        ...
        {
            var menus = await Vben5NavigationManager.GetAll();
    ...
    private async Task<Menu> SeedMenuAsync(Layout layout, Data data, string name, string path, string code, string component, string displayName, string redirect = "", string description = "", Guid? parentId = null, Guid? tenantId = null, Dictionary<string, object> meta = null, string[] roles = null, Guid[] users = null, bool isPublic = false)
    {
        var menu = await RouteDataSeeder.SeedMenuAsync(layout, name, path, code, component, displayName, redirect, description, parentId, tenantId, isPublic);
