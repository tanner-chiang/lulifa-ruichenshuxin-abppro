...
public class SystemOrganizationUnitAppService : PlatformAppService, ISystemOrganizationUnitAppService
{
    ...
    public SystemOrganizationUnitAppService(
    ...
    [Authorize(PlatformPermissions.OrganizationUnits.Update)]
    ...
    [Authorize(PlatformPermissions.OrganizationUnits.ManageRoles)]
    ...
    [Authorize(PlatformPermissions.OrganizationUnits.ManageUsers)]
    ...
    {
        var specification = new SystemOrganizationUnitGetListSpecification(input);
    ...
    [Authorize(PlatformPermissions.OrganizationUnits.Create)]
    ...
    [Authorize(PlatformPermissions.OrganizationUnits.Delete)]
